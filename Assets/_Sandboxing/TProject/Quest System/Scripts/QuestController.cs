...
namespace Tproject.Quest
{
    public class QuestController : MonoBehaviour
    {
        ...
        public DataManagerScriptableObject dataManager;
        [HideInInspector] public List<DataManagerScriptableObject.QuestItem> toDoList;
        ...
        public void FinishItem(int index)
        {
            ...
            {
                DataManagerScriptableObject.QuestItem temp = dataTarget[index];
                temp.isDone = true;
