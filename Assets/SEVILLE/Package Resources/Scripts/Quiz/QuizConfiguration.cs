...
namespace Seville
{
    ...
    {
        [Space(2f)]
        [Tooltip("OnQuizOpen event will be called after player open the quiz")]
        public UnityEvent OnQuizOpen;
        [Space(4f)]
        [Tooltip("OnQuizClose event will be called after player close the quiz")]
        public UnityEvent OnQuizClose;
        [Space(4f)]
        [Tooltip("GetCorrectScore event will be called after player submit the quiz")]
